...
import { CreaterepertoireWorkspace } from '../../../src/components/repertoire/CreateRepertoireWorkspace';
...
export default function CreaterepertoirePage() {
