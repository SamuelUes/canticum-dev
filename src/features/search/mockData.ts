...
const items: SearchEntityItem[] = [
  ...
  },
  {
    ...
    kind: 'schema',
    type: 'schema',
    schemaId: 'schema-misa-pentecoste',
    title: 'Misa de Pentecostés',
    subtitle: 'Estructura principal',
    liturgicalType: 'Litúrgico',
    liturgicalTime: 'Pentecostés',
    authorOrChoir: 'Coro Emanuel',
    searchableText: 'misa pentecostes esquema estructura coro emmanuel liturgico',
  ...
  },
  {
    ...
    kind: 'schema',
    type: 'schema',
    schemaId: 'schema-concierto-jovenes',
    title: 'Concierto Juvenil',
    subtitle: 'Setlist de actividad',
    liturgicalType: 'Evento',
    liturgicalTime: 'Ordinario',
    authorOrChoir: 'Grupo Fiat',
    searchableText: 'concierto juvenil esquema setlist actividad grupo fiat evento ordinario',
  ...
  },
  {
    ...
    kind: 'schema',
    type: 'schema',
    schemaId: 'schema-boda-alianza',
    title: 'Boda',
    subtitle: 'Misa solemne',
    liturgicalType: 'Litúrgico',
    liturgicalTime: 'Ordinario',
    authorOrChoir: 'María Luz',
    searchableText: 'boda esquema misa solemne maria luz liturgico ordinario',
  ...
  },
  {
    ...
    kind: 'schema',
    type: 'schema',
    schemaId: 'schema-orquesta-vigilia',
    title: 'Orquesta',
    subtitle: 'Ensayo general',
    liturgicalType: 'Evento',
    liturgicalTime: 'Adviento',
    authorOrChoir: 'Grupo Fiat',
    searchableText: 'orquesta esquema ensayo vigilia grupo fiat evento adviento',
...
const buckets: SearchBuckets = {
  ...
  schemas: buildBucket(items.filter((item): item is SearchSchemaItem => item.kind === 'schema')),
